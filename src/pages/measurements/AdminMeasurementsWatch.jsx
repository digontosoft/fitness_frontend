...
import AdminSingleCart from "@/components/measurements/measurementWatch/AdminSingleCart";
...
const AdminMeasurementsWatch = () => {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      title="מעקב היקפים"
       className="py-0" />
      <AdminSingleCart userId={userId} setOpen={setOpen} setId={setId} />
...
export default AdminMeasurementsWatch;
