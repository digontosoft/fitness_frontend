          ...
          >
            ...
            <div className="max-w-3xl mx-auto space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div className="space-y-5">
                  <FInput
                    label="אם בחרת בבית - איזה אביזרים יש ברשותך או שתרצה לרכוש? למשל גומיות, רצועות TRX, משקולות, מתח, ספת משקולות? מומלץ משקולות  (יש לדלג אם בחרת חד''כ)"
                    placeholder="התשובה שלך"
                    name="home_equipment"
                    dir="rtl"
                  />
                  ...
                  />
                  <FInput
                    label="עושה ספורט נוסף? (תחביב או מקצועי)"
                    placeholder="התשובה שלך"
                    name="favorite_cardio"
                    dir="rtl"
                  />
          ...
          >
            ...
            <div className="max-w-3xl mx-auto space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 ">
                ...
                <div className="space-y-5">
                  <FInput
                    label="אם בחרת בבית - איזה אביזרים יש ברשותך או שתרצי לרכוש? למשל גומיות, רצועות  TRX,משקולות, מתח, ספת משקולות? מומלץ משקולות (יש לדלג אם בחרת חד''כ)"
                    placeholder="התשובה שלך"
                    name="home_equipment"
                    dir="rtl"
                  />
