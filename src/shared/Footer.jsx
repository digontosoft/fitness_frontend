...
const Footer = () => {
  return (
    <div className="bg-gradient-to-t from-[rgb(148,0,25)] to-[#FD4753]  h-[100px]">
      <div className="max-w-7xl mx-auto lg:py-10 py-2 px-2 md:py-4 flex flex-col md:flex-row justify-center md:justify-between items-center md:gap-10 ">
