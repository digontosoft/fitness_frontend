...
import axios from "axios";
import { useEffect, useState } from "react";
import { useForm } from "react-hook-form"; // Removed 'set' as it's not used from react-hook-form
import { toast } from "sonner";
import Select from "react-dropdown-select";
import AddExercise from "./AddExercise"; // Assuming this component is designed to take an 'exercise' prop and an 'onChange' prop
import { useNavigate } from "react-router-dom";
import DynamicTextAreaField from "@/components/measurements/DynamicTextAreaField";
import { bodyPartOptions, equipmentOptions } from "@/constants/exerciseData";
