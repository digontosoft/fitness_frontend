              ...
              {workoutData?.exercises && workoutData?.exercises.length > 0 ? (
                <div className="space-y-4">
                  {workoutData?.exercises.map((exercise) => (
                    <div
                      key={exercise?._id}
                      className="rounded-md p-3 shadow-md border border-gray-300 bg-gradient-to-tr from-slate-100 to-gray-100"
                    >
                      <div className="flex flex-col items-center justify-center space-y-4 sm:space-y-6">
                        <div className="border p-2 w-full sm:w-2/4 rounded-md">
                          <h4 className="font-medium text-center">
                            {exercise?.exercise_id?.name}
                          </h4>
                        </div>
